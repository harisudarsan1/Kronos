...
#[derive(Copy, Clone, Debug)]
#[repr(C)]
pub enum TCPAllowMap {
    LNvalue(Allowrule),
    Rule(TCPRule),
}

#[cfg(feature = "user")]
unsafe impl aya::Pod for TCPAllowMap {}
...
#[cfg(feature = "user")]
unsafe impl aya::Pod for TCPRule {}

#[derive(Copy, Clone, Debug)]
#[repr(C)]
pub enum UDPAllowMap {
    LNvalue(Allowrule),
    Rule(UDPRule),
}

#[cfg(feature = "user")]
unsafe impl aya::Pod for UDPAllowMap {}
...
#[cfg(feature = "user")]
unsafe impl aya::Pod for UDPRule {}

#[derive(Copy, Clone, Debug)]
#[repr(C)]
pub enum DNSAllowMap {
    LNvalue(Allowrule),
    Rule(DNSRule),
}

#[cfg(feature = "user")]
unsafe impl aya::Pod for DNSAllowMap {}
...
#[cfg(feature = "user")]
unsafe impl aya::Pod for DNSRule {}
